				...
				<div className="d-flex flex-row bd-highlight mb-3">
					<div className="bd-highlight">
						<DropdownButton
							...
							onSelect={(event) => props.editCartQuantityHandler(event, item.id)}
						>
			...
			<Row>
				...
				<Col md={4} className="">
					...
					<div className="d-flex justify-content-between mt-3">
						...
						<div className="pr-2 bd-highlight" style={{ color: 'rgb(250, 84, 0)', fontWeight: '500' }}>
							Free
						</div>
					</div>
					<hr />
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		removeCartItemHandler: (index) => dispatch({ type: actionTypes.REMOVE_CART_ITEM, index: index })
	};
};
