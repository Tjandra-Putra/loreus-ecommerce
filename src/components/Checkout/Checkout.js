          ...
          <main className="mt-5">
            <div className="personal-details">
              <Row>
                ...
                <Col d={6} xm={12}>
                  <strong className="float-right">view summary</strong>
                </Col>
              </Row>
              <Row>
                <Col md={4} xm={12}>
                  <small className="font-weight-bold text-muted">01</small>
            ...
            <div className="shipping-details">
              <Row className="mt-5">
                <Col md={4} xm={12}>
                  <small className="font-weight-bold text-muted">02</small>
                  <h5 style={{ fontWeight: "600" }}>SHIPPING DETAILS</h5>
                </Col>
                <Col md={8} xm={12}>
                  <h6 className="pt-4">Shipping address</h6>
                  <Form.Group>
                    <Form.Label className="text-muted pt-3">
                      Street Address
                    </Form.Label>
                    <Form.Control type="text" />
                  </Form.Group>
            ...
            <div classname="payment-details">
              <Row style={{ marginTop: "6vh" }}>
                <Col md={4} xm={12}>
                  <small className="font-weight-bold text-muted">03</small>
