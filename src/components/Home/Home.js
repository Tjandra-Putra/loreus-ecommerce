          ...
          <Col className="p-0" xs={12} md={6}>
            <div className="left-area">
              ...
              <p className="description">
                ...
                with all the events. You can see and feel everything in clothes.
                Start shopping now to enjoy exclusive offers!
              </p>
        ...
        <Row>
          <Col className="text-center">
            ...
            <div className="featured-description">
              Enjoy the modern design, which corresponds with the latest summer
              fashion trends.
            </div>
          </Col>
        </Row>
